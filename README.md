...
> Пример работы с данными <https://address.gitdata.ru/> и <https://GitDataOrg.github.io/AddressRU/>.
...
> [Копия ресурсов КЛАДР на ресурсах GitHub](https://gitdataorg.github.io/AddressRU) находятся в директории <https://gitdataorg.github.io/AddressRU/data/>.
...
- [Станица проекта на GitData](http://address.gitdata.ru) (с примером работы)
