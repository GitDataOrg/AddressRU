...
_К сведению самый большой размер 195 Кб [`77.json`](https://address.gitdata.ru/data/77.json), относящийся к городу Москве. Ранее без оптимизации по размеру лидиировал файл [`64000001.json`](https://address.gitdata.ru/data/64000001.json), относящийся к городу Саратов. После оптимизации стал вторым - 185 Кб_ 
